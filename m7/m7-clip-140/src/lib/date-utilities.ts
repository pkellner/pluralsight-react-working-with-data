export function prismaDateToIsoString(
  ...
  try {
    ...
    let offset =
      startTimeLocal.getTimezoneOffset() *
      60000; // Convert offset to milliseconds
    const adjustedDate = new Date(
      startTimeLocal.getTime() - offset,
    ); // Add the offset
    ...
    console.log(
      "prismaDateToIsoString: Error converting date:",
      e,
    );
...
export function isoStringDateToPrismaDate(
