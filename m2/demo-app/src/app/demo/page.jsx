      ...
      <div className="row">
        {speakers.map((speaker) => (
          <div key={speaker.id} className="col-4">
            <div className="card">
              <img src={`/images/speaker-${speaker.id}.jpg`} alt={`${speaker.firstName} ${speaker.lastName}`}
              ...
              <div className="card-body">
                ...
                <ul className="list-unstyled">
                  <li>
                    <img src={`/images/${speaker.favorite ? 'heart-red.png' : 'heart-dark.png'}`} onClick={() => toggleFavorite(speaker.id)}  alt="Favorite"/>
                  </li>
                </ul>
              </div>
            </div>
